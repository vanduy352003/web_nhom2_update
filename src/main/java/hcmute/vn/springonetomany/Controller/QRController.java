...
import hcmute.vn.springonetomany.Entities.QRDetailsPOJO;
...
public class QRController {
	...
	public String genrateQRCode(@ModelAttribute("qr") QRDetailsPOJO qrDetailsPOJO,Model model) {
		...
		File outputfile = new File("D:\\Code\\workspace-spring\\web3\\src\\main\\resources\\static\\img\\image_"+qrDetailsPOJO.getName()+".jpg");
